...
The topics that are necessary for an L2 agent to work with most Core System Services are:<br>
...
• [direct_execution_info](agent_communication/topics/direct_execution_info.md) - Level 2 and above agents<br>